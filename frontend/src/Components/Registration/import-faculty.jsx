...
const ImportRegFaculty = () => {
    ...
    const handleImportCorrectedData = async () => {
        ...
        try {
            ...
            const sendChunk = async (chunk) => {
                try {
                    await axios.post(`${BackendAPI}/reguser/importfaculty`, {
            ...
            SweetAlert.fire({
                title: 'Success',
                text: 'Faculty correct data imported successfully !',
                text: sendEmail ?
    ...
    const handleDownloadSampleFile = async () => {
        try {
            ...
            console.log("hello");
            const response = await axios.get(`${BackendAPI}/reguser/facultyimportsamplefile`, {
    ...
    const handleDownloadInstructionFile = async () => {
        try {
            // Make a GET request to the sample file route
            console.log("hello");
            const response = await axios.get(`${BackendAPI}/reguser/facultyimportinstructionfile`, {
                responseType: 'blob' // Specify responseType as 'blob' to handle binary data
            });
...
export default ImportRegFaculty;
