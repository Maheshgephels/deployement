...
import { required, email, NAME, Img, PDF, option, number, radio, expiryDate, username1, password } from '../Utils/validationUtils';
...
const EditBasicUser = () => {
    ...
    const onSubmit = async (formData) => {
        ...
        try {
            ...
            const token = getToken();
            await axios.post(`${BackendAPI}/reguser/editBasicUser`, values, {
                headers: {
                    Authorization: `Bearer ${token}` // Include the token in the Authorization header
                }
            });
