...
const AppLayout = ({ children, classNames, ...rest }) => {
  ...
  const sideBarIcon = localStorage.getItem("Usersidebar_icon_type") || sidebarIconType;
  const location = useLocation();
  const { animation } = useContext(AnimationThemeContext);
  const animationTheme = localStorage.getItem("Useranimation") || animation || ConfigDB.data.router_animation;
