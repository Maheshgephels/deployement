...
const ColorsComponent = () => {
  ...
  const default_color = localStorage.getItem("Userdefault_color") || ConfigDB.data.color.primary_color;
  const secondary_color = localStorage.getItem("Usersecondary_color") || ConfigDB.data.color.secondary_color;
