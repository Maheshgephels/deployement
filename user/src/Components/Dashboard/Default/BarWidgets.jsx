...
const primary = localStorage.getItem('Userdefault_color') || ConfigDB.data.color.primary_color;
const secondary = localStorage.getItem('Usersecondary_color') || ConfigDB.data.color.secondary_color;
            ...
            <div className='bar-chart-widget'>
              <CardBody className='bottom-content'>
                {chartData.categories.length === 0 ? (
                  <Alert color='info'>No data found</Alert>
                ) : (
                  <Row>
                    <Col>
                      <div id='chart-widget4'>
                        <Charts
                          options={{
                            ...
                            theme: { mode: 'light' },
                            chart: { background: '#f4f4f4', toolbar: { show: false } },
                            plotOptions: {
