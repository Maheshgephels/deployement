...
const WidgetsWrapper = () => {
  ...
  return (
    <>
      ...
      <CustomBreadcrumbs mainTitle="Category Count" />
      <Row>
      ...
      {widgetFacilityTotalData.length > 0 && (
        <>
          ...
          <CustomBreadcrumbs mainTitle="Total Facility Counts" />
  ...
  <>
    ...
    <CustomBreadcrumbs mainTitle="Facility Day Wise Counts" />
    {dataWidgetWithPercent.map((item, i) => (
      <Col xl='3' sm='6' key={i}>
        {/* <Link to="/Facility-scan-records/Consoft"> */}
