...
const Ordersummary = ({ category, setCategory, addonticket, setAddonTicket, regAmount, totalPaidAmount, setRegAmount, settotalPaidAmount, currency, gstamount,
    gstfee,
    gstinclded,
    processinginclded,
    processingfeeornot,
    ...
    useEffect(() => {
        ...
        setTotalAmount(roundTo(updatedTotal));
        ...
        <Fragment>
            <Container>
                ...
                <Card body>
                    ...
                    {discountcoupon === "Yes" || (!showPromoCodeInput && discountcoupon !== "No") ? (
                        <Row className="mb-3">
                            <Col xs="6">
                                <p
                                    style={{ cursor: 'pointer', color: '#007bff' }}
