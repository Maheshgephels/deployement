...
const UserFeedback = () => {
    ...
    const onSubmit = async (formData) => {
        try {
            ...
            if (response.data.success) {
                ...
                // Check if feedback form is enabled in the settings
                if (settings.certificate === 'Yes' && settings.certificateWithFeedback === 'Yes') {
                    // Call handlePrintCertificate with the user data, but do not print certificate only in feedback form
    ...
    return (
        <div>
            <Breadcrumbs mainTitle="Feedback" parent="User" title="Feedback" />
