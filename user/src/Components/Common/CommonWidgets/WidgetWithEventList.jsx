...
const WidgetWithEventList = ({ data, mainClass, onRemove }) => {
  ...
  const handleViewDetails = () => {
    navigate(`${process.env.PUBLIC_URL}/manage-user/Consoft`, { state: { catID, Title }});
  };
...
export default WidgetWithEventList;
