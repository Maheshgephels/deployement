...
// function GrapesEditor({ formDataToSend }) {
//   const navigate = useNavigate(); // Use useNavigate hook inside component

//   useEffect(() => {
//     const editor = grapesjs.init({
//       container: "#gjs",
//       width: "100%",
//       height: "500px", // Set a height to display the editor
...
//       // Extract pName from formDataToSend
//       let pNameValue;
...
//             navigate(`${process.env.PUBLIC_URL}/Manage-page/Consoft`);
//           }
//         });
//       } catch (error) {
